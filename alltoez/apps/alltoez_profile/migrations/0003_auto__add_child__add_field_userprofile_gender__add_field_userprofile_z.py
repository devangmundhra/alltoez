...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Child'
        db.create_table(u'alltoez_profile_child', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', to=orm['auth.User'])),
            ('gender', self.gf('django.db.models.fields.PositiveSmallIntegerField')(db_index=True, null=True, blank=True)),
            ('age', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'alltoez_profile', ['Child'])

        # Adding field 'UserProfile.gender'
        db.add_column(u'alltoez_profile_userprofile', 'gender',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'alltoez_profile_child')

        # Deleting field 'UserProfile.gender'
        db.delete_column(u'alltoez_profile_userprofile', 'gender')
    ...
    models = {
        u'alltoez_profile.child': {
            ...
            'gender': ('django.db.models.fields.PositiveSmallIntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'alltoez_profile.userprofile': {
            ...
            'gender': ('django.db.models.fields.PositiveSmallIntegerField', [], {'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
