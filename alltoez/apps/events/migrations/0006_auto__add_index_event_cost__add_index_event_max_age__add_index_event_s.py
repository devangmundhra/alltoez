...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Event', fields ['url']
        db.delete_unique(u'events_event', ['url'])

        # Adding index on 'Event', fields ['cost']
        db.create_index(u'events_event', ['cost'])

        # Adding index on 'Event', fields ['max_age']
        db.create_index(u'events_event', ['max_age'])

        # Adding index on 'Event', fields ['start_date']
        db.create_index(u'events_event', ['start_date'])

        # Adding index on 'Event', fields ['end_date']
        db.create_index(u'events_event', ['end_date'])

        # Adding index on 'Event', fields ['min_age']
        db.create_index(u'events_event', ['min_age'])

        # Adding index on 'Event', fields ['created_at']
        db.create_index(u'events_event', ['created_at'])


    def backwards(self, orm):
        # Removing index on 'Event', fields ['created_at']
        db.delete_index(u'events_event', ['created_at'])

        # Removing index on 'Event', fields ['min_age']
        db.delete_index(u'events_event', ['min_age'])

        # Removing index on 'Event', fields ['end_date']
        db.delete_index(u'events_event', ['end_date'])

        # Removing index on 'Event', fields ['start_date']
        db.delete_index(u'events_event', ['start_date'])

        # Removing index on 'Event', fields ['max_age']
        db.delete_index(u'events_event', ['max_age'])

        # Removing index on 'Event', fields ['cost']
        db.delete_index(u'events_event', ['cost'])

        # Adding unique constraint on 'Event', fields ['url']
        db.create_unique(u'events_event', ['url'])
