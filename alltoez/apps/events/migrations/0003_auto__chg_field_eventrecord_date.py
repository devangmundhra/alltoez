...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventRecord.date'
        db.alter_column(u'events_eventrecord', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'EventRecord.date'
        db.alter_column(u'events_eventrecord', 'date', self.gf('django.db.models.fields.DateTimeField')())
