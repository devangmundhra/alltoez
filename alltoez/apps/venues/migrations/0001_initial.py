    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default=b'Unspecified', help_text=b'Venue name', max_length=200)),
                ('slug', models.SlugField(help_text=b'The part of the name (if provided) that is used in the url.                             Leave this blank if you want the system to generate one for you.', null=True, blank=True)),
                ('neighborhood', models.CharField(help_text=b'Neigborhood/rough area of venue. Leave blank for auto-fill', max_length=200, null=True, blank=True)),
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(help_text=b'Phone number, if available', max_length=128, blank=True)),
            ],
            options={
                'abstract': False,
            },
